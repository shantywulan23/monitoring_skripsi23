                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body text-justify">
                                <p>Jika kamu mencetak kartu bimbingan ini maka kamu dinyatakan telah selesai melakukan
                                    bimbingan skripsi.</p>
                            </div>
                            <div class="modal-footer">
                                <a href="{{ route('bimbingan.cetak-kartu-bimbingan', $dosen) }}"
                                    class="btn btn-primary px-5">Cetak</a>
                            </div>
                        </div>
                    </div>
                </div>
