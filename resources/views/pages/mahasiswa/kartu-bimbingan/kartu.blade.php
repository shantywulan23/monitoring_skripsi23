...
<body>
    <div class="container">
        <div class="row justify-content-center text-center">
            <div class="col-3">
                <img src="{{ url('musamus.png') }}" alt="" srcset=""
                    style=" width: 150px; margin-left: -300px; margin-bottom; -200px;">
            </div>
            <div class="col-9 mt-4" style="margin-left: -240px;">
                <h4>KEMENTERIAN PENDIDIKAN, KEBUDAYAAN, RISET, DAN TEKNOLOGI</h4>
                <h4 style="margin-top: -12px;">UNIVERSITAS MUSAMUS (UNMUS)</h4>
                <h4 style="margin-top: -12px;">FAKULTAS TEKNIK</h4>
                <h4 style="margin-top: -12px;">JURUSAN SISTEM INFORMASI</h4>
                <p style="margin-top: -10px; font-size: 16px;">Jl. Kamizaun Mopah Lama Merauke 99611</p>
                <p style="font-size: 16px; margin-top: -20px;">Telp. 0971-325923 Faksimile 0971-325976</p>
                <p style="font-size: 16px; margin-top: -20px;">Email: si@unmus.ac.id</p>
            </div>
        </div>
                    ...
                    <tbody>
                        @foreach ($items as $item)
                            <tr>
                                ...
                                <td class="text-center"><img src="{{ asset('tanda-tangan/' . $item->tanda_tangan) }}"
                                        alt="" width="100"></td>
                            </tr>
                        @endforeach
                    </tbody>
        ...
        <div class="d-flex justify-content-end">
            <p style="padding-right: 150px; margin-top: 10px;">Merauke,
                {{ \Carbon\Carbon::now()->translatedFormat('d F Y') }}</p>
        </div>
        <div class="d-flex justify-content-between" style="margin-top: 12px;">
            <div class="col-lg-6" style="padding-left: 60px;">
                <p>Ketua Jurusan</p>
                <p style="margin-top: 100px;"><strong>Ir. Jarot Budiasto, S.T, M.T</strong></p>
                <p style="margin-top: -20px;">NIDN : 0016029206</p>
            </div>
            <div class="col-lg-6" style="padding-left: 250px;">
                ...
                @else
                    <p style="margin-top: 100px;"><strong>{{ Auth::user()->dosen_pendamping->dosen->nama }}</strong>
                    </p>
